...
LocketMonsters = /*#__PURE__*/function () {function LocketMonsters() {_classCallCheck(this, LocketMonsters);_defineProperty(this, "propertyName",
    ...
    function printLocket(limit) {
      ...
      map((group) => {
        ...
        g.groupName = group.groupName;var _iterator9 = _createForOfIteratorHelper(

        group.monsters),_step9;try {for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {var m = _step9.value;
      ...
      (0,external_kolmafia_namespaceObject.print)("Hover over the monsters to see locations");var _iterator10 = _createForOfIteratorHelper(

      unknown),_step10;try {for (_iterator10.s(); !(_step10 = _iterator10.n()).done;) {var group = _step10.value;
          monstersPrinted += group.monsters.length;
          linesPrinted++;

          if (group.groupName == null) {var _iterator11 = _createForOfIteratorHelper(
            group.monsters),_step11;try {for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {var _monster5 = _step11.value;
    ...
    function getAllZones() {
      ...
      zoneData),_step12;try {for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {var data = _step12.value;
          ...
          external_kolmafia_namespaceObject.Location.all()),_step13;try {for (_iterator13.s(); !(_step13 = _iterator13.n()).done;) {var loc = _step13.value;
              if (loc.zone != zone.id) {
                continue;
              }
